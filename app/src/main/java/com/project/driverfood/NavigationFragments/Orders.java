...
import com.project.driverfood.mylibrary.OrderRiderItem;
import com.project.driverfood.mylibrary.Restaurateur;
import com.project.driverfood.mylibrary.Utilities;
...
public class Orders extends Fragment implements OnMapReadyCallback {
    ...
    private void setOrderView(View view,OrderRiderItem order)
    {
        ...
        cash_text.setText("Rp "+order.getTotPrice());
    }
